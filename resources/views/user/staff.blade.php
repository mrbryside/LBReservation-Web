...
<div class="container" id="allmenu">
    <div class="row">
        <div class="col-md-12 col-md-offset-0">
            ...
            <br>
            <br>
            <h2 class="ui left floated header"><font size = "5" color ="#828282">SEARCH</font><br><font size = "6" color ="#B92000">STAFF</font></h2>
            ...
            <div class="ui clearing divider"></div>
            	<form action="{{ url('/user/show/staffsearch') }}" method="post" class="form-inline">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    <div class ="form-group">
                      <input type ="text" class ="form-control" name="s" id ="border" placeholder="Staff ID or Name" value="{{ isset($s) ? $s : '' }}">
                    </div>     
                      <button class="btn btn-success form-control" type="submit" id ="border">Search</button>
              </form>
              <br>
              <br>
              <h2 class="ui left floated header"><font size = "5" color ="#828282">LIST</font><br><font size = "6" color ="#B92000">STAFFS</font></h2>
                ...
                <div class="table-responsive table-inverse" id="table">
                  <table class="table table-bordered" id ="border">
                    ...
                    <thead>
                      ...
                      <th class="bg-primary">Staff Manange</th>
                    </tr>
                    </thead>                 
