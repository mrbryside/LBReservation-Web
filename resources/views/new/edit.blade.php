...
<div class="container" id ="allmenu">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            <br>
            <br>
            <h2 class="ui left floated header"><font size = "6" color ="#B92000">EDIT</font><br> <font size = "5" color ="#828282">NEWS</font></h2>
            <a href ="{{ url('/new') }}">
          ...
          <div class="ui raised segment">
            ...
            @endif
						<form class="form-horizontal" action="{{ url('/new/'.$New->Newid) }}" method="post" enctype="multipart/form-data" onsubmit="return confirm('Are you sure?')">
                ...
                <font size ="3">
        					<div class="form-group">
        						...
        						<div class="col-md-6">
        							<input type="text" class="form-control" name="NewTitle" value="{{ $New->NewTitle }}" required>
        						</div>
        					</div>
        					<div class="form-group">
        						<label class="col-md-4 control-label">New Description<font color ="red">**</font></label>
        						<div class="col-md-6">
        							<input type="text" class="form-control" name="NewDescription" value ="{{ $New->NewDescription }}" required>
        						</div>
        					</div>
        					<div class="form-group">
        						<label class="col-md-4 control-label">Image banner</label>
        						<div class="col-md-6">
        					...
        					<div class="form-group">
        						<div class="col-md-12">
        							<textarea name="NewParagraph1" class="form-control">{{ $New->NewParagraph1 }}</textarea>
        						</div>
        					</div>
                </font>
      					<div class="form-group">
