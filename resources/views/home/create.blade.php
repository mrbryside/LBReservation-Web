...
<div class="container" id ="allmenu">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
              ...
              <br>
              <br>
              <h2 class="ui left floated header"><font size = "6" color ="#B92000">CREATE</font><br> <font size = "5" color ="#828282">ROOM</font></h2>
              <a href ="{{ url('/home') }}">
            ...
            <div class="ui clearing divider"></div>
                <div class="ui raised segment">
                  ...
                  @endif
      						<form class="form-horizontal" action="{{ url('/home') }}" method="post" enctype="multipart/form-data" onsubmit="return confirm('Are you sure?')">
      							<input type="hidden" name="_token" value="{{ csrf_token() }}">
                    <font size ="3">
      							<div class="form-group">
      								<label class="col-md-4 control-label">Room Name<font color ="red">**</font></label>
      								<div class="col-md-6">
      									<input type="text" class="form-control" name="RoomName" value="{{ old('RoomName') }}" required>
      								</div>
      							</div>
      							<div class="form-group">
      								<label class="col-md-4 control-label">Room Description<font color ="red">**</font></label>
      								<div class="col-md-6">
      									<textarea name="RoomDescription" class="form-control" required>{{ old('RoomDescription') }}</textarea>
      								</div>
      							</div>
      							<div class="form-group">
      								<label class="col-md-4 control-label">Room People<font color ="red">**</font></label>
      								<div class="col-md-6">
      									<input type="string" name="RoomPeople" class="form-control" value="{{ old('RoomPeople') }}" required>
      								</div>
      							</div>
      							<div class="form-group">
                        ...
                        <select  class ="form-control pull-left" class="drop" name="RoomFloor">
                            ...
                            @for($i = 1;$i<=4;$i++)
                              <option value="{{ isset($i) ? $i : ''}}" @if (old('RoomFloor') == $i) selected="selected" @endif >{{$i}}</option>
                            @endfor
                        </select>
                      </div>
      							</div>
