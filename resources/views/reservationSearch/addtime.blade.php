...
<div class="container" id ="allmenu">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            <br>
            <br>
            <h2 class="ui left floated header"><font size = "5" color ="#828282">ADD</font><br> <font size = "6" color ="#B92000">TIME</font></h2>
            <a href ="{{ url('/reservationsearch') }}">
          ...
          <div class="ui raised segment">       
            ...
            @endif
						<form class="form-horizontal" action="{{ url('/add/'.$ReserID) }}" method="post" enctype="multipart/form-data" onsubmit="return confirm('Are you sure?')">
							<input type="hidden" name="_token" value="{{ csrf_token() }}">
              <input type="hidden" name="_method" value="PUT">
              <font size ="3">
  							<div class="form-group">
  								<label class="col-md-4 control-label">Time Value (30-60 min)<font color ="red">**</font></label>
  								<div class="col-md-6">
  									<input type="int" class="form-control" name="AddTime" required>
  								</div>
  							</div>
              </font>
							<div class="form-group">
