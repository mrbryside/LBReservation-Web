...
<div class="container" id ="allmenu">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
              ...
              <br>
              <br>
              <h2 class="ui left floated header"><font size = "6" color ="#B92000">CREATE</font><br> <font size = "5" color ="#828282">CONTACT</font></h2>
              <a href ="{{ url('/contact') }}">
            ...
            <div class="ui clearing divider"></div>
                <div class="ui raised segment">
                  ...
                  @endif
				  <form class="form-horizontal" action="{{ url('/contact') }}" method="post" enctype="multipart/form-data" onsubmit="return confirm('Are you sure?')">
					<input type="hidden" name="_token" value="{{ csrf_token() }}">
                		<font size ="3">
  							<div class="form-group">
  								<label class="col-md-4 control-label">Web Name</label>
  								<div class="col-md-6">
  									<input type="text" class="form-control" name="WebName" required autofocus>
  								</div>
  							</div>
  							<div class="form-group">
