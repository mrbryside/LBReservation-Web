            ...
            <div class="container" id ="bar">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href = "{{ url('/contact') }}">
                        <font color ="white" size="3"><b><img width ="40" height ="27" src="{{ asset('/seimg/table.png') }}">&nbsp;&nbsp;CONTACTS</b></font>
                    </a>
                </div>
...
<div class="container" id ="allmenu">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
              ...
              <br>
              <br>
              <h2 class="ui left floated header"><font size = "6" color ="#B92000">EDIT</font><br> <font size = "5" color ="#828282">CONTACT</font></h2>
              <a href ="{{ url('/contact') }}">
            ...
            <div class="ui clearing divider"></div>
                <div class="ui raised segment">
                  ...
                  @endif
                  <br>
				<form class="form-horizontal" action="{{ url('/contact/'.$Contact->ContactID) }}" method="post" enctype="multipart/form-data" onsubmit="return confirm('Are you sure?')">
					...
					<input type="hidden" name="_method" value="PUT">
      					<font size ="3">
							<div class="form-group">
								...
								<div class="col-md-6">
									<input type="text" class="form-control" name="WebName" value="{{ $Contact->WebName }}" required autofocus>
								</div>
							</div>
							<div class="form-group">
								<label class="col-md-4 control-label">Phone</label>
								<div class="col-md-6">
									<input type="text" class="form-control" name="Phone" value="{{ $Contact->Phone }}" required autofocus>
								</div>
							</div>
        				</font>
						<div class="form-group">      
