...
<div class="container" id ="allmenu">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
              ...
              <br>
              <br>
              <h2 class="ui left floated header"><font size = "6" color ="#B92000">EDIT</font><br> <font size = "5" color ="#828282">RULE</font></h2>
              <a href ="{{ url('/rule') }}">
            ...
            <div class="ui clearing divider"></div>
                <div class="ui raised segment">
                  ...
                  @endif
          <form class="form-horizontal" action="{{ url('/rule/'.$rule->rule_id) }}" method="post" enctype="multipart/form-data" onsubmit="return confirm('Are you sure?')">
            ...
            <input type="hidden" name="_method" value="PUT">
              <font size ="3">
                 <div class="form-group">
                  ...
                  <div class="col-md-6">
                    <input type="text" class="form-control" name="ruleTitle" value ="{{ $rule->RuleTitle }}" required autofocus>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-md-6">
                    <select  class ="form-control" id="ruleType" class="drop" name="ruleType" required>
                      ...
                      <option value="howto" @if ($rule->RuleType == 'howto') selected="selected" @endif>วิธีใช้</option>
                      <option value="rule" @if ($rule->RuleType == 'rule') selected="selected" @endif>ข้อปฏิบัติ</option>
                    </select>
                  </div>
                </div>
                  <div class="form-group">
                    ...
                    <div class="col-md-6" style="padding-right:0;">
                      <div>
                        <input id="rowInput1" type="text" style="width:70%;display:inline;" class="form-control" name="rowInput1" value="{{ $ruleItemFirst->ruleText }}" required autofocus>
                        <button type="button" class="btn btn-primary" id="add">เพิ่มอีก</button>
                      
                        <div id="allField" style="margin-top:10px;">
                          <?php $i = 2; ?>
                          @foreach($ruleItems as $ruleItem)
                              <div id="{{'row'.$i }}" style="margin-bottom:10px;"><input value="{{ $ruleItem->ruleText }}" id="{{ 'rowInput'.$i }}" type="text" style="width:70%;display:inline;" class="form-control" name="{{ 'rowInput'.$i }}" required autofocus><button type="button" style="margin-left:7px;"class="btn btn-danger" id="{{ $i }}">ลบ</button>
                              </div>                  
                            <?php $i++; ?>
                          @endforeach
                        </div>
